                ...
                <div class="container-fluid py-4">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="${pageContext.request.contextPath}/admin/manage-tiers"
                                            class="text-decoration-none text-secondary">Hạng Thành Viên</a>
                                    </li>
                    ...
                    <form action="${pageContext.request.contextPath}/admin/edit-tier" method="POST"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control ${not empty tierNameError ? 'is-invalid' : ''}"
                                name="tierName" value="${tier.tierName}" required>
                            <c:choose>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control" name="minPoints" min="0"
                                value="${tier.minPointsRequired}" required>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control" name="multiplier" step="0.1" min="1.0" max="2.0"
                                value="${tier.pointMultiplier}" required>
