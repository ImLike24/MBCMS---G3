...
<head>
    ...
    <title>Thêm Hạng Thành Viên - Admin</title>
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold mb-1" style="color: #212529;">Thêm Hạng Thành Viên</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" style="color: #d96c2c;">Thêm mới</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <!-- Form -->
    <form action="${pageContext.request.contextPath}/admin/create-tier" method="POST"
        ...
        <div class="col-md-3">
            ...
            <input type="number" class="form-control" name="multiplier" step="0.1" min="1.0" value="1.0" required>
        ...
        <div class="col-12 mt-4 pt-3 border-top">
            <button type="submit" class="btn btn-orange px-5 me-2">
                <i class="fas fa-save me-2"></i>Lưu Hạng
            </button>
