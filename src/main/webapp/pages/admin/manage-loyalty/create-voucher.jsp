<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <head>
            ...
            <title>Tạo Voucher Mới - Admin</title>
            ...
            <main>
                <div class="container-fluid py-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h3 class="fw-bold mb-1" style="color: #212529;">Tạo Voucher Mới</h3>
                    ...
                    <!-- Form -->
                    <form action="${pageContext.request.contextPath}/admin/create-voucher" method="POST"
            ...
            <script>
                ...
                function handleTypeChange() {
                    if (voucherType.value === 'PUBLIC') {
                        codeLabel.innerHTML = 'Nhập mã khuyến mãi (Bắt buộc)';
