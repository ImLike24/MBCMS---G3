...
<html lang="vi">
<head>
    <title>Hiệu suất theo Phim</title>
...
<main>
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-end mb-4">
            <div>
                <h3 class="fw-bold text-dark mb-1">Hiệu suất theo Phim</h3>
                <span class="text-secondary small">Số suất chiếu, vé bán, doanh thu theo từng phim</span>
            </div>
        ...
        <div class="card card-custom mb-4">
            <div class="card-body p-4">
                <form action="${pageContext.request.contextPath}/manager/report/performance/movie" method="get" class="row g-3">
                    <div class="col-md-4">
                ...
                <div class="table-responsive">
                    <table class="table table-custom table-hover align-middle mb-0">
                        ...
                        <c:forEach var="r" items="${rows}">
                            <tr>
                                <td class="ps-4">
                                    <i class="fa fa-film text-muted me-2"></i>
                                    <strong>${r.movieTitle}</strong>
                                </td>
                                <td>${r.showtimesCount}</td>
                                <td>${r.ticketsSold}</td>
                                <td class="text-end pe-4 fw-bold text-success">
                                    <fmt:formatNumber value="${r.revenue}" type="number" maxFractionDigits="0"/> đ
                                </td>
                            </tr>
                        </c:forEach>
