...
<html lang="vi">
<head>
    <title>Hiệu suất Phòng chiếu</title>
...
<main>
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-end mb-4">
            <div>
                <h3 class="fw-bold text-dark mb-1">Hiệu suất Phòng chiếu</h3>
                <span class="text-secondary small">Số suất chiếu, vé bán, doanh thu theo từng phòng</span>
            </div>
        ...
        <div class="card card-custom mb-4">
            <div class="card-body p-4">
                <form action="${pageContext.request.contextPath}/manager/report/performance/screening-room" method="get" class="row g-3">
                    <div class="col-md-4">
