...
<html lang="vi">
<head>
    <title>Báo cáo Doanh thu theo Phim</title>
...
<main>
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-end mb-4">
            <div>
                <h3 class="fw-bold text-dark mb-1">Doanh thu theo Phim</h3>
                <span class="text-secondary small">Doanh thu từng phim trong khoảng thời gian</span>
            </div>
        ...
        <div class="card card-custom mb-4">
            <div class="card-body p-4">
                <form action="${pageContext.request.contextPath}/manager/report/revenue/movie-report" method="get" class="row g-3 align-items-end">
                    <div class="col-md-3">
