...
<html lang="vi">
<head>
    <title>Báo cáo Doanh thu theo Chi nhánh</title>
...
<main>
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-end mb-4">
            <div>
                <h3 class="fw-bold text-dark mb-1">Doanh thu theo Chi nhánh</h3>
                <span class="text-secondary small">Tổng hợp doanh thu từng chi nhánh trong khoảng thời gian</span>
            </div>
        ...
        <div class="card card-custom mb-4">
            <div class="card-body p-4">
                <form action="${pageContext.request.contextPath}/manager/report/revenue/branch-report" method="get" class="row g-3">
                    <div class="col-md-4">
