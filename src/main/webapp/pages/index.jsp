                    ...
                    <div class="modal fade" id="exampleModal7" tabindex="-1" aria-labelledby="exampleModalLabel" style="display: none; top:0;" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content bg-transparent border-0">
                                ...
                                <div class="modal-body">
                                    <img src="${pageContext.request.contextPath}/img/16.jpg" class="w-100" alt="abc">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-5 p-0 col-sm-5">
                            <div class="event_1ril position-relative">
                                <div class="event_1ril1">
                                    <div class="grid clearfix">
                                        <figure class="effect-jazz mb-0">
                                            <a href="#"><img src="${pageContext.request.contextPath}/img/17.jpg" height="240" class="w-100" alt="abc"></a>
                                        </figure>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-5 p-0 col-sm-5">
                            <div class="event_1ril position-relative">
                                <div class="event_1ril1">
                                    <div class="grid clearfix">
                                        <figure class="effect-jazz mb-0">
                                            <a href="#"><img src="${pageContext.request.contextPath}/img/18.jpg" height="240" class="w-100" alt="abc"></a>
                                        </figure>
                                    </div>
                                </div>
                                <div class="event_1ril2 position-absolute w-100 top-0">
                                    ...
                                    <div class="col-md-12">
                                        <div class="testim_1i1 bg-white p-4 clearfix">
                                            ...
                                            <div class="testim_1i1i clearfix mt-3">
                                                <span><img src="${pageContext.request.contextPath}/img/19.jpg" alt="abc" class="rounded-circle me-3 float-start"></span>
                                ...
                                <div class="testim_1i row">
                                    <div class="col-md-12">
                                        <div class="testim_1i1 bg-white p-4 clearfix">
                                            <span class="d-inline-block bg_oran text-white text-center span_1 rounded-circle"><i class="fa fa-quote-left"></i></span>
                                            <div class="testim_1i1i clearfix mt-3">
                                                <span><img src="${pageContext.request.contextPath}/img/20.jpg" alt="abc" class="rounded-circle me-3 float-start"></span>
