    ...
    <div class="result-container">
        ...
        <div class="result-body">
            ...
            <div class="status-card <%= statusClass %>">
                ...
                <p class="mb-0">Mã giao dịch: <%= request.getParameter("vnp_TxnRef") != null ? request.getParameter("vnp_TxnRef") : "N/A" %></p>
            </div>
            ...
            <div class="text-center mt-5">
                <button type="button" class="btn btn-lg btn-primary px-5" onclick="window.location.href='${pageContext.request.contextPath}/'">
