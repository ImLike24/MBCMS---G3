...
@WebServlet(name = "PaymentMethod", urlPatterns = {"/manager/report/revenue/payment-method"})
public class PaymentMethod extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        var rows = revenueRepo.getRevenueByPaymentMethod(branchIds, fromDate, toDate);
        ...
        request.getRequestDispatcher("/pages/manager/report/revenue/payment-method.jsp").forward(request, response);
    }
