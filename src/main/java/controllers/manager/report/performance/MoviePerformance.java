...
@WebServlet(name = "MoviePerformance", urlPatterns = {"/manager/report/performance/movie"})
public class MoviePerformance extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        var rows = perfRepo.getMoviePerformance(branchIds, fromDate, toDate);
        ...
        request.getRequestDispatcher("/pages/manager/report/performance/movie.jsp").forward(request, response);
    }
