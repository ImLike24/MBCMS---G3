...
@WebServlet(name = "OperationalReport", urlPatterns = {"/manager/report/performance/operational-report"})
public class OperationalReport extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        var row = perfRepo.getOperationalReport(branchIds, fromDate, toDate);
        ...
        request.getRequestDispatcher("/pages/manager/report/performance/operational-report.jsp").forward(request, response);
    }
