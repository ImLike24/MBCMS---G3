...
@WebServlet(name = "counterBookingConcessions", urlPatterns = {"/staff/counter-booking-concessions"})
public class CounterBookingConcessions extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/pages/staff/counter-booking-concessions.jsp").forward(request, response);
