...
public class TicketPriceService {
    ...
    /**
     * Lịch: Thứ 7 / Chủ nhật → WEEKEND, còn lại → WEEKDAY.
     * Không tự biết ngày lễ quốc gia; giá ngày lễ dùng {@link #resolveDayTypeForTicketPrice}.
     */
    ...
    /**
     * Khung giờ trùng form cấu hình manager (ticket-price): MORNING [0,12), AFTERNOON [12,17),
     * EVENING [17,21), NIGHT còn lại (gồm 21–23 và 0–5).
     */
    ...
    /**
     * Nếu manager đã cấu hình dòng ADULT + HOLIDAY còn hiệu lực cho đúng ngày chiếu và khung giờ
     * thì dùng HOLIDAY; không thì WEEKDAY/WEEKEND theo lịch (không có bảng ngày lễ riêng trong DB).
     */
    ...
    public BigDecimal getBasePriceForShowtime(int branchId, LocalDate date, LocalTime time) {
        ...
        String dayType = resolveDayTypeForTicketPrice(branchId, date, time, priceDao);
